...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Parent_Aps_Task",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Parent_Aps_Task11AppDelegate")
...
SWIFT_CLASS("_TtC15Parent_Aps_Task8CityCell")
@interface CityCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified AddOrRemove;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified CityName;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (IBAction)AddOrRemoveBtn:(id _Nonnull)sender;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15Parent_Aps_Task19CityForecastingCell")
@interface CityForecastingCell : UITableViewCell
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified Tempreature;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified Sky;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
@interface CityForecastingVC (SWIFT_EXTENSION(Parent_Aps_Task)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15Parent_Aps_Task13SceneDelegate")
...
@interface WeatherForecastingSearchVC (SWIFT_EXTENSION(Parent_Aps_Task))
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
@end


@interface WeatherForecastingSearchVC (SWIFT_EXTENSION(Parent_Aps_Task)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
